...
% sbatch -c 1 -N 1 -A all -C scratch --mem=100G -t 48:00:00 -o "/scratch1/users/sternbach1/MarsupialData/output/output_HPC_MakeJackknifeSamplesWallabyH_Trials10.txt" --wrap='matlab -batch "!./HPC_MakeJackknifeSamplesWallabyOPM 'H' 1 10"'
