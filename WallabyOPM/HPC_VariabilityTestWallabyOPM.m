function HPC_VariabilityTestWallabyOPM(DImageDataFileName,VarName,NBootstrapSamples,seed,Filename)
    
    DImageData = load(DImageDataFileName,VarName);  % Function output form of LOAD
    DImageData = DImageData.(VarName);
...
%     disp([getMapSize(DImageData) 1])
    ...
    save(Filename, 'AllMaps','MaXDeltaOPM','ConfidenceIntervalls')
end
