function HPC_MakeBootstrapSamplesIbbotsonOPM(Animal,NBootstrapSamples,TrialsToUse1, TrialsToUse2,seed)
    ...
    disp('run main function: MakeBootstrapSamples')
    disp('--------------------------------------------')
    AllMaps = MakeBootstrapSamplesIbbotsonOPM(dimg_cut,str2num(NBootstrapSamples),str2num(seed));
    disp('--------------------------------------------')

    disp('save data')
    %save([datafolder 'BootstrapSamples' num2str(NBootstrapSamples) 'Wallaby'  WallabyList(Wallaby) '.mat'],'AllMaps');
    save([datafolder 'BootstrapSamples' num2str(NBootstrapSamples) Animal 'Trials' TrialsToUse1 '-' TrialsToUse2 '.mat'],'AllMaps');
    disp('--------------------------------------------')
...
% cd /scratch1/users/sternbach1/MarsupialData/CompiledCode/HPC_MakeBootstrapSamplesIbbotsonOPM
% sbatch -c 1 -N 1 -A all -C scratch --mem=100G -t 48:00:00 -o "/scratch1/users/sternbach1/MarsupialData/output/output_HPC_MakeBootstrapSamplesCatBCTrial10.txt" --wrap='matlab -batch "!./HPC_MakeBootstrapSamplesIbbotsonOPM 'CatBC' 1000 1 10 5"'
