...
h = rectangle('Position',[x y lx ly],'FaceColor',getRGB_colorsOPM(2*angle));%[x-cos(angleRectangle)*r y-sin(angleRectangle)*r x+cos(angleRectangle)*r y+sin(angleRectangle)*r]
