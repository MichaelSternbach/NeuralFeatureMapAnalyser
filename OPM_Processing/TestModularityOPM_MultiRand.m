function [power_profiles,mean_abs_squared,mean_abs_squared2] =TestModularityOPM_MultiRand(data_obj,profile_range_mm,N_seeds,direction_data)
    ...
    parfor ii = 1:N_seeds
        ...
        z = data_obj_rand.read_map(1,false,direction_data);
