function compareParameterGIF(animal,specimen_num_list,AnimalDataFolder,FigureFolder,ElectrodePosition,SN_th_range)
    ...
    if length(specimen_num_list)>1
        ...
        FigureFileName = [FigureFolder 'ComparisonParameterGIF_' animal '_all'];
