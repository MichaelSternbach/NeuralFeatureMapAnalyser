function AnimalFactSheetHPC(animal,experiment_num,AnimalDataFolder,DataFolderMain,FigureFolder)
    ...
    %% figure folder
    if rectangle ~= false
         FolderFigures = [FigureFolder animal '/' data_info.ID '_rectangle'];
    else
        FolderFigures = [FigureFolder animal '/' data_info.ID ];
    end
    mkdir(FolderFigures)
    ...
    FigureFile = [FolderFigures '_FactSheet'];
