function plotCIDirectionPreference(experiment_num_list,animal,AnimalDataFolder,FigureFolder,...
...
%     highpass_mm = 0.56;
    ...
    FigureFile = [FigureFolder animal '_CI_DirectionPrefernceGIF' num2str(GIF_SN_TH)];   
...
%         hold on; set(gca,'view',[rotate rotate])
        print(f1,'-dpsc','-fillpage', [FigureFolder animal num2str(experiment_num) 'DirCI.ps'])
